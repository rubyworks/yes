...
YES is a schema system for YAML that intuitve and extremely powerful.
...
simply collects all matching nodes with their applicable constraint into
a *unit-validation*. Then this collection is filtered of all *passing*
validations. All that is left are the failures. If the filtered
